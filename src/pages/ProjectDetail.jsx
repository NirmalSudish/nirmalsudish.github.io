            ...
            <div className="container mx-auto max-w-7xl text-center">
                <div className="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 sm:px-8">
                    <div data-aos="fade-up" className="max-w-4xl w-full">
                        ...
                        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8 text-center border-t border-white/20 pt-8"> 
                    ...
                    <nav className="flex justify-between items-center max-w-7xl mx-auto border-t border-white/10 pt-12">
                        <Link to={`/project/${prevProjectId}`} className="group flex flex-col items-start text-left cursor-pointer">
                            ...
                            <div className="relative overflow-hidden h-10 md:h-16">
                                ...
                                <span className="absolute top-0 left-0 block text-3xl md:text-6xl font-black uppercase transition-transform duration-500 translate-y-full group-hover:translate-y-0 text-gray-500">Prev</span>
                            </div>
                        </Link>
                        <Link to={`/project/${nextProjectId}`} className="group flex flex-col items-end text-right cursor-pointer">
                            ...
                            <div className="relative overflow-hidden h-10 md:h-16">
                                ...
                                <span className="absolute top-0 right-0 block text-3xl md:text-6xl font-black uppercase transition-transform duration-500 translate-y-full group-hover:translate-y-0 text-gray-500">Next</span>
                            </div>
                        </Link>
                    </nav>
                </div>
