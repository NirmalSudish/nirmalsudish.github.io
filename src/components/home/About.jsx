...
const About = () => {
  return (
    <section id="about" className="w-full py-0 pt-24 md:pt-0 bg-transparent relative z-10 overflow-hidden">
      <div className="container mx-auto px-6 md:px-12 lg:px-20">
        <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-start lg:items-center">

          {/* LEFT COLUMN: Personal Image */}
          <div className="w-3/4 md:w-5/12 mx-auto md:mx-0">
          ...
          <div className="w-full md:w-7/12 text-center md:text-left">
            <ScrollReveal delay={0.2}>
              ...
              <div className="mt-8 mb-16 relative inline-flex items-center justify-center p-[1.5px] overflow-hidden rounded-full group mx-auto md:mx-0">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-10 gap-x-12 pt-12 border-t border-black/10 dark:border-white/10 mb-8 place-items-center md:place-items-start">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 px-8 py-4 bg-black text-white dark:bg-white dark:text-black font-black uppercase tracking-[0.2em] text-sm rounded-full hover:bg-gray-800 dark:hover:bg-gray-200 transition-all duration-300 hover:scale-105 active:scale-95 mx-auto md:mx-0"
              >
