  ...
  return (
    ...
    >
      {isProject ? (
        ...
        <div className="h-[30vh] md:h-[clamp(260px,46vh,520px)] w-full md:w-auto rounded-xl overflow-hidden bg-zinc-900 border border-white/5 relative flex items-center justify-center">
  ...
  return (
    <section id="work" className="relative h-[100dvh] flex flex-col items-center pt-20 pb-4 md:pt-20 md:pb-0 lg:pt-32 lg:pb-16 bg-transparent z-10 overflow-hidden justify-center">
      ...
      <div className="w-full relative group/marquee flex-grow flex-col justify-center hidden md:flex overflow-hidden" style={{ maskImage: 'linear-gradient(to right, transparent 0%, black 8%, black 92%, transparent 100%)', WebkitMaskImage: 'linear-gradient(to right, transparent 0%, black 8%, black 92%, transparent 100%)' }}>
        ...
        <button onClick={() => handleScroll('left')} className="absolute left-6 md:left-12 top-1/2 -translate-y-1/2 z-50 w-16 h-16 rounded-full border border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 backdrop-blur-2xl opacity-0 group-hover/marquee:opacity-100 transition-all duration-300 flex items-center justify-center active:scale-90 shadow-2xl hover:bg-white dark:hover:bg-white hover:border-white hover:scale-110 hover:shadow-[0_0_24px_rgba(255,255,255,0.3)] group/lbtn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-6 h-6 text-white group-hover/lbtn:text-black transition-colors duration-300"><path d="M15 18l-6-6 6-6" /></svg></button>
        <button onClick={() => handleScroll('right')} className="absolute right-6 md:right-12 top-1/2 -translate-y-1/2 z-50 w-16 h-16 rounded-full border border-black/20 dark:border-white/20 bg-black/5 dark:bg-white/5 backdrop-blur-2xl opacity-0 group-hover/marquee:opacity-100 transition-all duration-300 flex items-center justify-center active:scale-90 shadow-2xl hover:bg-white dark:hover:bg-white hover:border-white hover:scale-110 hover:shadow-[0_0_24px_rgba(255,255,255,0.3)] group/rbtn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-6 h-6 text-white group-hover/rbtn:text-black transition-colors duration-300"><path d="M9 18l6-6-6-6" /></svg></button>
