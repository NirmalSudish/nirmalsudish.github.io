        ...
        <ScrollReveal delay={0.2}>
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {[
              ...
              <button key={f.id} onClick={() => { setActiveFilter(f.id); setIsPaused(false); }} className={`group relative flex items-center gap-3 px-6 py-3 md:px-10 md:py-4 rounded-full transition-all duration-500 text-[10px] md:text-xs font-black uppercase tracking-widest backdrop-blur-2xl ${activeFilter === f.id ? 'bg-black text-white dark:bg-white dark:text-black ring-2 ring-transparent dark:ring-white scale-105 shadow-[0_0_30px_-5px_rgba(199,146,255,0.4)]' : 'bg-transparent ring-2 ring-inset ring-black/10 dark:ring-white text-black dark:!text-white hover:bg-black/5 dark:hover:bg-white/10'}`}>
